...
class WhisperSTT:
    ...
    def __init__(self, model_name: str = "base", language: str | None = None):
        ...
        self._language = "en" if (not language or language.strip().lower() in ("auto", "en", "en-us")) else language.strip().lower()
        self._device = "cpu"
        self._model = None
    ...
    def transcribe(self, audio: np.ndarray, beam_size: int = 1, **kwargs) -> str:
